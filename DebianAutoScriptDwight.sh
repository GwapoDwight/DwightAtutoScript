...
clear
echo "                                              ivsv                          vii "                      
echo " irYjIVVUuvi  SvuXqPBi      jQuvi  BbXVPQi    vKPEPbdEi      ii  BQqqdPX   iivYkSqPRd "      
echo "BXSUUujsujVXKsBqLsJskI XBr  BuuVqkBRrvLvXv  PgKuJYYLJdv EDKqPdD  BvvYvvBgIqSXkUuussuE "      
echo "QvrvvvSVrvvvvvRBrrvvvUgBvP BkvvvvUiBIvvLD  BXvvvvvrrrP  BDrvvju ZRrvvvrBQvvvvvvvvvSDP "      
echo "BvrrvvYPQivvvirBBirrvrKrrrBRirvrP igJrvruiQIrrrrrvjPuU  DdirvvUiBvrrvruiBsgSrrvrvUr "        
echo "BuirrJ  Birrrrv BEirrririrrrrvrVi DZirrriVBiirijXiiEZjrvBbirrrrvirrrrrX   XQirrrrK "         
echo "BSiirvvjUirrriS  Bviririiiririsu  DdiiriikBiiiiEBiiiiirrMDiiririiirirrX   qRiirrrX "         
echo "gZiiirvriiiriYk  YBiiiiIBiiiivK   DEiiiiiiBLiiirMQLiirirsBiiirvqZiirivu   qMiiirrS "         
echo "qQiiiiiiiiirUs    BgiiLiVBiiiq    MPiiiir iQiiiiiLriiiviiQiiirivMiiiivv   dZiiiirs "         
echo "jB iiiiiivJJi      Brik  QBiki    gP iiiiv uBJiiiiiiivI  BiiiiiBKiiiisi   MBiiiiiv "         
echo "iBVIkukuYi         rBI    BBi     BQvvuuqr  iQBKuLsJjr   JqEDSVUXVPPPP     sXdgPZi "         
echo "                    r             ivii         iiii          i                 ii "         
echo ""                                                                                               
